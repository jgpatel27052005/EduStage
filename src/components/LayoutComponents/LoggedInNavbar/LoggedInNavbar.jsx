...
import logooo from '../../../../public/images/EduStage.png'
    ...
    <div className={css.navbar}>
      ...
      <div className={css.left}>
        <Link className={css.logoBox} to="/">
          <img src={logooo} alt="logo" className={css.logo} />
        </Link>
      </div>
          ...
          <div className={css.menuBox}>
            <div className={css.innerMenuBox}>
              <div className={css.prflDiv}>
                <Link to="/user/profile/settings/basic" className={css.user}>
                  ...
                  <div className={css.rightUserDiv}>
                    <div className={css.uname}>User</div>
                    <div className={css.email}>user@gmail.com</div>
                  </div>
                </Link>
              </div>
              <hr className={css.hr} />
              ...
              <div className={css.prflDiv}>
                <div className={css.menuItem2}>
                  <span>
                    <div className={css.menuItemTxt1}></div>
