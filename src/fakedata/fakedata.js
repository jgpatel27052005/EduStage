...
import bannerImg3 from "/images/banners/ES.gif";
...
const det = {
  ...
  desc: "Instructors from around the world teach millions of students on EduStage. We provide the tools and skills to teach what you love.",
...
const det2 = {
  ttl: "EduStage Bussiness",
  desc: "Get unlimited access to 17,000+ of EduStage’s top courses for your team. Learn and improve skills across business, tech, design, and more.",
  btnTxt: "Get EduStage Business",
  btnLink: "/start-teaching",
  img: showcaseImg2,
  dir: "right",
};
...
const bannerData = [
  ...
  },
  {
    ...
    boxData: {
      ...
      desc: "EduStage Business is trusted by 12.5K+ companies around the world. Find out what we can do for yours.",
    },
  },
  {
    id: 3,
...
const toolsResources = [
  {
    ...
    icon: teachIcon,
    ttl: "Test Video",
    txt: "Get free feedback from EduStage video experts on your audio, video, and delivery.",
  },
  {
    id: "tr-2",
    icon: groupUsersIcon,
    ttl: "Marketplace Insights",
    txt: "Get EduStage-wide market data to create successful courses.",
  },
  {
    id: "tr-3",
    icon: askIcon,
...
const helpResources = [
  {
    ...
    icon: teachIcon,
    ttl: "Teaching Center",
    txt: "Find articles on EduStage teaching — from course creation to marketing.",
  },
  {
    id: "hr-2",
    icon: groupUsersIcon,
